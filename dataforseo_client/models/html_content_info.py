...
class HtmlContentInfo(BaseModel):
    ...
    description_to_content_consistency: Optional[StrictFloat] = Field(default=None, description=r"consistency of the meta description tag with the page contentmeasured from 0 to 1")
    title_to_content_consistency: Optional[StrictFloat] = Field(default=None, description=r"consistency of the meta title tag with the page contentmeasured from 0 to 1")
    meta_keywords_to_content_consistency: Optional[StrictFloat] = Field(default=None, description=r"consistency of meta keywordstag with the page contentmeasured from 0 to 1")
