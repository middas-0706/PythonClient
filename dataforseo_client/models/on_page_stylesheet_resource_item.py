...
class OnPageStylesheetResourceItem(BaseOnPageResourceItem):
    ...
    meta: Optional[ResourceMetaInfo] = Field(default=None, description=r"page propertiesthe value depends on the resource_type")
    fetch_timing: Optional[FetchTiming] = Field(default=None, description=r"time range within which a result was fetched")
    accept_type: Optional[StrictStr] = Field(default=None, description=r"indicates the expected type of resourcefor example, if 'resource_type': 'broken', accept_type will indicate the type of the broken resourcepossible values:any, none, image, sitemap, robots, script, stylesheet, redirect, html, text, other, font")
