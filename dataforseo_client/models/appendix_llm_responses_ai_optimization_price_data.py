...
class AppendixLlmResponsesAiOptimizationPriceData(BaseModel):
    """
    AppendixLlmResponsesAiOptimizationPriceData
    """ # noqa: E501
    live: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    models: Optional[AppendixTaskKeywordsDataPriceDataInfo] = Field(default=None, description=r"")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        _dict['models'] = self.models.to_dict() if self.models else None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "models": AppendixTaskKeywordsDataPriceDataInfo.from_dict(obj["models"]) if obj.get("models") is not None else None,
