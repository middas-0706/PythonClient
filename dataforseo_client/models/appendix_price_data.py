...
from dataforseo_client.models.appendix_ai_optimization_price_data import AppendixAiOptimizationPriceData
...
class AppendixPriceData(BaseModel):
    ...
    ai_optimization: Optional[AppendixAiOptimizationPriceData] = Field(default=None, description=r"")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ai_optimization": AppendixAiOptimizationPriceData.from_dict(obj["ai_optimization"]) if obj.get("ai_optimization") is not None else None,
