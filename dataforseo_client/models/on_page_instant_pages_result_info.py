...
class OnPageInstantPagesResultInfo(BaseModel):
    ...
    crawl_status: Optional[Any] = Field(default=None, description=r"details of the crawling sessionin this case the value will be null")
    crawl_gateway_address: Optional[StrictStr] = Field(default=None, description=r"crawler ip addressdisplays the IP address used by the crawler to initiate the current crawling sessionyou can find the full list of IPs used by our crawler in the Overview section")
