...
class OnPageHtmlResourceItem(BaseOnPageResourceItem):
    ...
    size: Optional[StrictInt] = Field(default=None, description=r"resource sizeindicates the size of a given page measured in bytes")
    encoded_size: Optional[StrictInt] = Field(default=None, description=r"page size after encodingindicates the size of the encoded page measured in bytes")
    total_transfer_size: Optional[StrictInt] = Field(default=None, description=r"compressed page sizeindicates the compressed size of a given page")
    fetch_time: Optional[StrictStr] = Field(default=None, description=r"date and time when a resource was fetchedin the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”example:2019-11-15 12:57:46 +00:00")
    cache_control: Optional[CacheControl] = Field(default=None, description=r"instructions for caching")
    checks: Optional[Dict[str, Optional[StrictBool]]] = Field(default=None, description=r"website checkson-page check-ups related to the page")
    ...
    last_modified: Optional[LastModified] = Field(default=None, description=r"contains data on changes related to the resourceif there is no data, the value will be null")
    meta: Optional[PageMetaInfo] = Field(default=None, description=r"page propertiesthe value depends on the resource_type")
    ...
    custom_js_client_exception: Optional[StrictStr] = Field(default=None, description=r"error when executing a custom jsif the error occurred when executing the script you specified in the custom_js field, the error message would be displayed here")
    ...
    click_depth: Optional[StrictInt] = Field(default=None, description=r"number of clicks it takes to get to the pageindicates the number of clicks from the homepage needed before landing at the target page")
